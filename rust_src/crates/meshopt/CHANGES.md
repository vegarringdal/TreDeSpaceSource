...
* Upgraded vendored meshoptimizer library to v1.2 (tag v1.2, MESHOPTIMIZER_VERSION 1020)
  for the 20-45% faster SSSE3/AVX vertex codec decode. `tangentspace.cpp` is vendored
  but not compiled (no tangent bindings).
