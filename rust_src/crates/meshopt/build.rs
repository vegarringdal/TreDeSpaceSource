...
fn main() {
    ...
    let source_files = [
        ...
        // v1.1 new files
        "vendor/src/meshletcodec.cpp",
        "vendor/src/meshletutils.cpp",
        "vendor/src/opacitymap.cpp",
    ];
    ...
    if target.starts_with("wasm32") {
        ...
        // No C++ runtime either: no exceptions/RTTI, no thread-safe static
        // guards, and operator new/delete come from our Rust-backed shim.
        build
            .flag("-fno-exceptions")
            .flag("-fno-rtti")
            .flag("-fno-threadsafe-statics")
            .file("wasm_shim/newdelete.cpp");
