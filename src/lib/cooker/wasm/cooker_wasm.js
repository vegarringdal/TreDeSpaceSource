/* @ts-self-types="./cooker_wasm.d.ts" */

export class CookResult {
    static __wrap(ptr) {
        const obj = Object.create(CookResult.prototype);
        obj.__wbg_ptr = ptr;
        CookResultFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        CookResultFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_cookresult_free(ptr, 0);
    }
    /**
     ...
     */
    get bounds() {
        const ret = wasm.cookresult_bounds(this.__wbg_ptr);
     ...
     */
    get bytes() {
        const ret = wasm.cookresult_bytes(this.__wbg_ptr);
     ...
     */
    get dense() {
        const ret = wasm.cookresult_dense(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
    ...
    get rootName() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.cookresult_rootName(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
 ...
 * @returns {CookResult}
 */
export function cook(glb, compute_normals, coarsen) {
 ...
 * @returns {number}
 */
export function cookerVersion() {
    const ret = wasm.cookerVersion();
    return ret >>> 0;
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./cooker_wasm_bg.js": import0,
    };
}

const CookResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_cookresult_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cooker_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
