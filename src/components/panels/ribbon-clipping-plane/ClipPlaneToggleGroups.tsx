...
/** The plane legend + per-axis enable toggles (On/Off), then the helper /
 *  gizmo toggles — the rows line up across the two sections. */
    ...
    <>
      <RibbonSection title="On/Off">
        {AXES.map(({ axis, label, dot }) => (
          <RibbonSlot key={axis} size="mini" className="min-w-0">
